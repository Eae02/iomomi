...
static const glm::vec3 coneMeshVertices[] = {
	glm::vec3(0.000000f, 1.000000f, -1.000000f),  glm::vec3(0.000000f, 0.000000f, 0.000000f),
	glm::vec3(0.382683f, 1.000000f, -0.923880f),  glm::vec3(0.707107f, 1.000000f, -0.707107f),
	glm::vec3(0.923880f, 1.000000f, -0.382683f),  glm::vec3(1.000000f, 1.000000f, 0.000000f),
	glm::vec3(0.923880f, 1.000000f, 0.382684f),   glm::vec3(0.707107f, 1.000000f, 0.707107f),
	glm::vec3(0.382683f, 1.000000f, 0.923880f),   glm::vec3(0.000000f, 1.000000f, 1.000000f),
	glm::vec3(-0.382683f, 1.000000f, 0.923880f),  glm::vec3(-0.707107f, 1.000000f, 0.707107f),
	glm::vec3(-0.923880f, 1.000000f, 0.382684f),  glm::vec3(-1.000000f, 1.000000f, -0.000000f),
	glm::vec3(-0.923879f, 1.000000f, -0.382684f), glm::vec3(-0.707107f, 1.000000f, -0.707107f),
	glm::vec3(-0.382683f, 1.000000f, -0.923880f)
};

static const uint16_t coneMeshIndices[] = { 0,  2,  1,  2,  3,  1,  3,  4,  1,  4,  5,  1, 5,  6,  1,  6,  7,  1,
	                                        7,  8,  1,  8,  9,  1,  9,  10, 1,  10, 11, 1, 11, 12, 1,  12, 13, 1,
	                                        13, 14, 1,  14, 15, 1,  15, 16, 1,  16, 0,  1, 10, 6,  14, 2,  0,  16,
	                                        16, 15, 14, 14, 13, 12, 12, 11, 10, 10, 9,  8, 8,  7,  6,  6,  5,  4,
	                                        4,  3,  2,  2,  16, 14, 14, 12, 10, 10, 8,  6, 6,  4,  2,  2,  14, 6 };
...
static void Initialize()
{
	...
	eg::Buffer uploadBuffer(eg::BufferFlags::CopySrc | eg::BufferFlags::MapWrite, uploadBytes, nullptr);
