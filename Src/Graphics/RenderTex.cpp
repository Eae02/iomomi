...
static inline eg::TextureFlags GetFlagsForRenderTexture(RenderTex texture)
{
	...
	default:
		return eg::TextureFlags::FramebufferAttachment | eg::TextureFlags::ShaderSample;
	}
}
...
RenderTexManager::RenderTexManager()
	: renderTextures(magic_enum::enum_count<RenderTex>()), renderTexturesRedirect(magic_enum::enum_count<RenderTex>())
{
}
