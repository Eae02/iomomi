...
template <>
std::vector<std::string> settingsCBOptions<ViewBobbingLevel>{ "Off", "Low", "Normal" };
template <>
std::vector<std::string> settingsCBOptions<eg::TextureQuality>{ "Low", "Medium", "High" };
template <>
std::vector<std::string> settingsCBOptions<SSAOQuality>{ "Off", "Low", "Medium", "High" };
template <>
std::vector<std::string> settingsCBOptions<BloomQuality>{ "Off", "Low", "High" };
template <>
std::vector<std::string> settingsCBOptions<QualityLevel>{ "Very Low", "Low", "Medium", "High", "Very High" };
template <>
std::vector<std::string> settingsCBOptions<DisplayMode>{ "Windowed", "Fullscreen", "Fullscreen Windowed" };
...
void InitOptionsMenu()
{
	...
	if (!eg::GameControllers().empty())
	{
		...
		joystickAxesCB.setValue = [](int value)
		{
			settings.flipJoysticks = value == 1;
			SettingsChanged();
		};
